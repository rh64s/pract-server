...
INSERT INTO `Posts` VALUES (1,'10 ловушек, которые точно можно поставить','Небрежное отношение к разработке ловушек может привести к тому, что вы придете к тому, что можно прийти к тому, что у вас закончатся материалы, что может привести к тому, что вы встанете на путь того, что вам будет не жизни и в итоге по итогу вы будете занятыдо своей '),(2,'Как ИИ превосходит человека в создании ложной информации','Если постараться, то можно получить прикольную и смешную информацию '),(3,'В дверь постучались 64 раза','8 осьминогов, подумал Штирлиц. Нет, ответили ему за дверью 32 инвалида колясочника');
...
INSERT INTO `Users` VALUES (1,'2D-дизайн','asdf','sdf','asdass@asd.sas','80800553535','200820e3227815ed1756a6b531e7e0d2',1,'asd'),(2,'wouyer','iouwer','qwuy','asdf1@aasd.ass','88005553535','efe6398127928f1b2e9ef3207fb82663',2,'qwoieuyr'),(3,'уцй','уцй','уцй','asdass@asd.sas','80800553535','200820e3227815ed1756a6b531e7e0d2',2,'йцу'),(4,'sakljdf','askjh','asdhf','asd@uuu.uu','81263812','76d80224611fc919a5d54f0ff9fba446',3,'askj');
...
-- Dump completed on 2026-03-21 14:12:09
